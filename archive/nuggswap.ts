...
// import { onSubmitOffer } from '../../archive/intervals';
...
//     return getSwapId(nft, tokenid, swapnum).concat('-').concat(account.toHexString());
// }
...
//     return nft.toHexString().concat('-').concat(tokenid.toString()).concat('-').concat(swapnum.toString());
// }

// export function getTokenId(nft: Address, tokenid: BigInt): string {
//     return nft.toHexString().concat('-').concat(tokenid.toString());
// }
